...
public class StartMuseumMain {
	...
	public static void main(String[] args) {
		...
		testStrings.add("* Display type is PEDISTAL *\n"
		...
		testStrings.add("* Display type is HANGFROMCELING *\n"
		...
		testStrings.add("* Display type is WALL *\n"
		...
		testStrings.add("* Display type is GLASSCASE *\n"
		...
		try {
			...
			while (index < numDisplays) {
				...
				String testString = testStrings.get(index);
				
				System.out.println(displayOut);
				if(displayOut.equals(testString)) {
					System.out.println(" ----- output exact match ----");
				}
...
//			Dinasaurs obj_3 = new Dinasaurs();
			...
			try {
				...
				Dinasaurs dino_5 = new Dinasaurs(check_nameOfTisArtifact, check_typOfDinasaur, check_description,
						check_year);

				testStr = dino_5.getTypeOfDinasaur(); // check this
				System.out.println(
			...
			try {
				...
				Dinasaurs dino_6 = new Dinasaurs(check_nameOfTisArtifact);
				testStr = dino_6.getNameOfArtifact(); // check this
				System.out.println(
						(testStr.equals(check_nameOfTisArtifact) ? doPass() : doFail()) + " - getNameOfArtifact()");

				dino_6.setTypeOfDinasaur(check_typOfDinasaur);
				testStr = dino_6.getTypeOfDinasaur(); // check this
				System.out.println(
						(testStr.equals(check_typOfDinasaur) ? doPass() : doFail()) + " - getTypeOfDinasaur()");
			...
			System.out.println("--------------------------------");
			System.out.println("This is an auto generated approximate score to help you track bugs.\nIt will probably be adjusted when your program submission is reviewed and an official grade is determined.");
